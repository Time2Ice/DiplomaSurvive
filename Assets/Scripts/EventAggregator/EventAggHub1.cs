...
{
    public abstract class EventAggHub<TEvent, TValue> : EventHubBase
        where TEvent : EventAggHub<TEvent, TValue>
    {
        ...
        public static TEvent operator +(EventAggHub<TEvent, TValue> eventHub, ISubscribed subscribed)
        {
    ...
    public abstract class EventAggHubV<TEvent, TValue> : EventAggHub<TEvent, TValue>
