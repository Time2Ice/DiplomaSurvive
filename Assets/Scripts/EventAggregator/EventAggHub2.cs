...
{
    public abstract class EventAggHub<TEvent, TValue1, TValue2> : EventHubBase
        where TEvent : EventAggHub<TEvent, TValue1, TValue2>
    {
        ...
        public static TEvent operator +(EventAggHub<TEvent, TValue1, TValue2> eventHub, ISubscribed subscribed)
        {
    ...
    public abstract class EventAggHubV<TEvent, TValue1, TValue2> : EventAggHub<TEvent, TValue1, TValue2>
