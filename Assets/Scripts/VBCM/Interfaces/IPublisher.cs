...
{
    public interface IPublisher<TEventHub>
        where TEventHub : EventHubBase<TEventHub>
    {
        EventSource<TEventHub> GetEventSource1();
    }
    
    public interface IPublisher<TEventHub1, TEventHub2>
    ...
    public interface IPublisher<TEventHub1, TEventHub2, TEventHub3>
        where TEventHub1 : EventHubBase<TEventHub1>
        where TEventHub2 : EventHubBase<TEventHub2>
    ...
    public interface IPublisher<TEventHub1, TEventHub2, TEventHub3, TEventHub4>
        where TEventHub1 : EventHubBase<TEventHub1>
        where TEventHub2 : EventHubBase<TEventHub2>
        where TEventHub3 : EventHubBase<TEventHub3>
    ...
    public interface IPublisher<TEventHub1, TEventHub2, TEventHub3, TEventHub4, TEventHub5>
        where TEventHub1 : EventHubBase<TEventHub1>
        where TEventHub2 : EventHubBase<TEventHub2>
        where TEventHub3 : EventHubBase<TEventHub3>
        where TEventHub4 : EventHubBase<TEventHub4>
